...
#PBS -N cl_c216p
#PBS -j o
#PBS -o sic_col216_p.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col216_p.
...
# System: 216 Si atoms, Si7.0-s2p2d1: col dim n=2808 / NC dim 2n=5616.
