...
#PBS -N sn216_2w
#PBS -j o
#PBS -o sibs_nc216_2n_w.joblog

# Si diamond BAND limited strong scaling (plan v2.6 sec. 7.4/8.5): sibs_nc216_2n_w.
# 2 node(s) x 48 ranks (-nt 1), 1 H100/node, MPS on; same input at every
