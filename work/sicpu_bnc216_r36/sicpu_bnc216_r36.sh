...
#PBS -N cpbn216_36
#PBS -j o
#PBS -o sicpu_bnc216_r36.joblog

# CPU best-config preflight (plan v2.6 sec. 6.2 / step 10): sicpu_bnc216_r36.
# 3-SCF + force, scf.eigen.lib elpa2, flat MPI: 1 node x 36 ranks (-nt 1),
