...
#PBS -N sn216_1w
#PBS -j o
#PBS -o sibs_nc216_1n_w.joblog

# Si diamond BAND limited strong scaling (plan v2.6 sec. 7.4/8.5): sibs_nc216_1n_w.
# 1 node(s) x 48 ranks (-nt 1), 1 H100/node, MPS on; same input at every
# node count (strong scaling, k-point parallelism over the 8 computed
# k points: 8/4/2 k per GPU at 1/2/4 nodes).  Config: 3-SCF preflight: warm-up + path check, NOT pooled into means.
