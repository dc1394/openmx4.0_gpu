...
#PBS -N sb_c512p
#PBS -j o
#PBS -o sib_col512_p.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col512_p.
...
# System: 512 Si atoms (conv supercell 4x4x4 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=6656, NC dim 2n=13312.
