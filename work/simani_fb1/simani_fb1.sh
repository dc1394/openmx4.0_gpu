...
#PBS -N pmfb1
#PBS -j o
#PBS -o simani_fb1.joblog

# H100 1-node production benchmark (plan v2.6 sec. 8.1/8.3): simani_fb1.
# 300 Si atoms from sidia.dat supercells, band solver, Kgrid 2x2x2 (8 computed k).
# Config: GPU gpusolver + MPS on, gemmul8 on -> INT8 FP64 emulation (Layer 3).
...
MPS_X="-x CUDA_MPS_PIPE_DIRECTORY -x CUDA_MPS_LOG_DIRECTORY -x OPENMX_BAND_GPU_DIAG"
