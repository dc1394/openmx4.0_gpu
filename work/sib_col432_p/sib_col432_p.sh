...
#PBS -N sb_c432p
#PBS -j o
#PBS -o sib_col432_p.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col432_p.
...
# System: 432 Si atoms (prim supercell 6x6x6 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=5616, NC dim 2n=11232.
