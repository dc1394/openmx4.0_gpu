...
#PBS -N cl_c360g
#PBS -j o
#PBS -o sic_col360_g.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col360_g.
...
# scf.maxIter 25, MD.Type Opt x1.  Config: gemmul8 on (25-SCF confirmation).
