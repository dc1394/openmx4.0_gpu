...
#PBS -N cl_c384p
#PBS -j o
#PBS -o sic_col384_p.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col384_p.
...
# System: 384 Si atoms, Si7.0-s2p2d1: col dim n=4992 / NC dim 2n=9984.
