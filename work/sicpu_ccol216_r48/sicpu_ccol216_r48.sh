...
#PBS -N cpcc216_48
#PBS -j o
#PBS -o sicpu_ccol216_r48.joblog

# CPU best-config preflight (plan v2.6 sec. 6.2 / step 10): sicpu_ccol216_r48.
# 3-SCF + force, scf.eigen.lib elpa2, flat MPI: 1 node x 48 ranks (-nt 1),
# whole node reserved (--cpunum-lhost=48), no GPU.  216 Si atoms, cluster solver, Gamma-only.
