...
#PBS -N sn216_8o11
#PBS -j o
#PBS -o sibs_nc216_8n_o11.joblog

# Si diamond BAND limited strong scaling (plan v2.6 sec. 7.4/8.5): sibs_nc216_8n_o11.
...
# k points: 8/4/2/1 k per GPU at 1/2/4/8 nodes).  Config: gemmul8 OFF -> plain cuBLAS FP64 (production rep).
