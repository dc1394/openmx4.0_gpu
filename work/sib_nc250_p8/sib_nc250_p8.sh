...
#PBS -N sb_n250p8
#PBS -j o
#PBS -o sib_nc250_p8.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_nc250_p8.
...
# System: 250 Si atoms (prim supercell 5x5x5 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=3250, NC dim 2n=6500.
