...
#PBS -N sb_c300p8
#PBS -j o
#PBS -o sib_col300_p8.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col300_p8.
...
# Config: gpusolver + MPS, gemmul8 on, default (3-SCF GO/NO-GO probe, plan step 5).
