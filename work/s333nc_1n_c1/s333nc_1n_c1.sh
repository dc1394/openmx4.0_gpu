...
#PBS -N s333_1c1
#PBS -j o
#PBS -o s333nc_1n_c1.joblog

# sidia333_nc campaign, CPU path (elpa2) -- one of 36 requests
# ({1,2,3,4} nodes x {gpusolver+gemmul8-on, gpusolver+gemmul8-off, elpa2} x 3
# reps, all -npernode 48).  Binary: round-3 (commit e227507).  384 Si,
# s2p2d1, non-collinear -> matrix dimension 5616, BAND solver (k-grid 2x2x2), 25 SCF.
# Old-binary refs (PPN=48): CPU 1n 934 s, 2n 542 s; Utot -887.4228308565xx.
...
echo "=== Utot (old-binary CPU ref: -887.422830856506) ==="
