...
#PBS --cpunum-lhost=48
#PBS --gpunum-lhost=1
#PBS -l elapstim_req=01:15:00
#PBS -T openmpi
#PBS -v NQSV_MPI_VER=nvhpc-hpcx-cuda13/25.11
#PBS -N s16_2d2
#PBS -j o
#PBS -o s443nc_2n16_d2.joblog

# sidia443_nc_cluster re-measurement at -npernode 16, GPU path (gpusolver2 = distributed ELPA 2026.02 + COSMA).
...
# 36-rank mean for this same point: 381.56 s total / 325.11 diag.
...
mpirun ${NQSV_MPIOPTS:-} -np "${NPROC}" -npernode "${PPN}" --timeout 3600 \
       ${MPS_X} \
