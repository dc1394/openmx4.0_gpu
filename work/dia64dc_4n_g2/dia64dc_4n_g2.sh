...
#PBS -N d64_4g2
#PBS -j o
#PBS -o dia64dc_4n_g2.joblog

# dia64_dc-lno node scaling, 4 node(s) x 48 ranks, GPU path (gpusolver + MPS, gemmul8 on).
...
# atom-owning ranks to min(numprocs, atomnum): of the 192 ranks here,
# 64 own a cluster.  Extra ranks still carry grid work, and Solver==11
...
echo "=== SCF iterations completed (of 50 max) ==="
