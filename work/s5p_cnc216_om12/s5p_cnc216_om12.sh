#!/bin/bash
# RTX 5080 local benchmark (rtx5080_procedure.md; plan v2.6 sec. 7.2/8.2/8.3): s5p_cnc216_om12.
# 216 Si atoms from sidia.dat supercells, cluster solver, Gamma-only.
# Config: GPU gpusolver, MPS OFF, gemmul8 off (plan 8.3 MPS ablation).
...

{
  echo "=== host      : $(hostname)"
  echo "=== date      : $(date)"
  echo "=== layout    : 1 node x ${NPROC} ranks, 1 RTX 5080, MPS OFF, gemmul8 off"
