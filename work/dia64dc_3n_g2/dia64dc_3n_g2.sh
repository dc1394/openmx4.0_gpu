...
#PBS -N d64_3g2
#PBS -j o
#PBS -o dia64dc_3n_g2.joblog

# dia64_dc-lno node scaling, 3 node(s) x 48 ranks, GPU path (gpusolver + MPS, gemmul8 on).
...
# atom-owning ranks to min(numprocs, atomnum): of the 144 ranks here,
