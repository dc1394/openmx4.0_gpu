...
#PBS -N abcolc11
#PBS -j o
#PBS -o siacc_bcol_c11.joblog

# Accuracy campaign (plan v2.6 sec. 7.5 / 13.2-B): siacc_bcol_c11.
...
# Config: CPU elpa2, flat MPI 48 ranks, no GPU.  48 ranks, -nt 1, whole node.
...
mpirun ${NQSV_MPIOPTS:-} -np "${NPROC}" -npernode "${PPN}" --timeout 5040 \
