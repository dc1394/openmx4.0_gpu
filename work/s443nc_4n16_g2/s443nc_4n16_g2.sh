...
#PBS -N s16_4g2
#PBS -j o
#PBS -o s443nc_4n16_g2.joblog

# sidia443_nc_cluster re-measurement at -npernode 16, GPU path (gpusolver, gemmul8 on).
...
# 36-rank mean for this same point: 134.30 s total / 91.21 diag.
