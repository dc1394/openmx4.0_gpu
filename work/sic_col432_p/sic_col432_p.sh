...
#PBS -N cl_c432p
#PBS -j o
#PBS -o sic_col432_p.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col432_p.
...
# System: 432 Si atoms, Si7.0-s2p2d1: col dim n=5616 / NC dim 2n=11232.
