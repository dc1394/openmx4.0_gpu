...
#PBS -N sn216_1o13
#PBS -j o
#PBS -o sibs_nc216_1n_o13.joblog

# Si diamond BAND limited strong scaling (plan v2.6 sec. 7.4/8.5): sibs_nc216_1n_o13.
...
# k points: 8/4/2 k per GPU at 1/2/4 nodes).  Config: gemmul8 OFF -> plain cuBLAS FP64 (production rep).
