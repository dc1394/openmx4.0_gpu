...
#PBS -N cl_c512p
#PBS -j o
#PBS -o sic_col512_p.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col512_p.
...
# System: 512 Si atoms, Si7.0-s2p2d1: col dim n=6656 / NC dim 2n=13312.
