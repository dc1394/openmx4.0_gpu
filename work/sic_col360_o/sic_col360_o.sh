...
#PBS -N cl_c360o
#PBS -j o
#PBS -o sic_col360_o.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col360_o.
...
# scf.maxIter 25, MD.Type Opt x1.  Config: gemmul8 OFF -> cuBLAS FP64 (25-SCF confirmation).
