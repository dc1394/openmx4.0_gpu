...
#PBS -N sb_c300g
#PBS -j o
#PBS -o sib_col300_g.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col300_g.
...
# System: 300 Si atoms (prim supercell 6x5x5 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=3900, NC dim 2n=7800.
# scf.EigenvalueSolver Band, scf.Kgrid 2x2x2 (8 computed k points), GGA-PBE,
# 200 Ry, scf.maxIter 25, criterion 1e-13 (fixed-iteration timing deck),
# MD.Type Opt with MD.maxIter 1 so the force step runs.  Mode: col.
# Config: gpusolver + MPS, gemmul8 on (25-SCF confirmation, step 6).
