...
#PBS -N sb_n216g
#PBS -j o
#PBS -o sib_nc216_g.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_nc216_g.
...
# System: 216 Si atoms (conv supercell 3x3x3 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=2808, NC dim 2n=5616.
