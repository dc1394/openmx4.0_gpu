...
#PBS -N cl_c250p
#PBS -j o
#PBS -o sic_col250_p.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col250_p.
...
# System: 250 Si atoms, Si7.0-s2p2d1: col dim n=3250 / NC dim 2n=6500.
