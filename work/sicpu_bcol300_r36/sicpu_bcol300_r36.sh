...
#PBS -N cpbc300_36
#PBS -j o
#PBS -o sicpu_bcol300_r36.joblog

# CPU best-config preflight (plan v2.6 sec. 6.2 / step 10): sicpu_bcol300_r36.
# 3-SCF + force, scf.eigen.lib elpa2, flat MPI: 1 node x 36 ranks (-nt 1),
# whole node reserved (--cpunum-lhost=48), no GPU.  300 Si atoms, band solver, Kgrid 2x2x2 (8 computed k).
