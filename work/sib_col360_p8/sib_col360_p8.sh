...
#PBS -N sb_c360p8
#PBS -j o
#PBS -o sib_col360_p8.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col360_p8.
...
# System: 360 Si atoms (prim supercell 6x6x5 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=4680, NC dim 2n=9360.
