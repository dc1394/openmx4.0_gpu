...
#PBS -N cl_n300p8
#PBS -j o
#PBS -o sic_nc300_p8.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_nc300_p8.
...
# System: 300 Si atoms, Si7.0-s2p2d1: col dim n=3900 / NC dim 2n=7800.
