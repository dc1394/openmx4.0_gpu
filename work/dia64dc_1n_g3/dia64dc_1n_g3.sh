...
#PBS -N d64_1g3
#PBS -j o
#PBS -o dia64dc_1n_g3.joblog

# dia64_dc-lno node scaling, 1 node(s) x 48 ranks, GPU path (gpusolver + MPS, gemmul8 on).
...
# atom-owning ranks to min(numprocs, atomnum): of the 48 ranks here,
# 48 own a cluster.  Extra ranks still carry grid work, and Solver==11
