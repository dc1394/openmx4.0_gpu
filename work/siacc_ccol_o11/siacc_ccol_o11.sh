...
#PBS -N accolo11
#PBS -j o
#PBS -o siacc_ccol_o11.joblog

# Accuracy campaign (plan v2.6 sec. 7.5 / 13.2-B): siacc_ccol_o11.
...
# Config: GPU gpusolver + MPS, gemmul8 off (cuBLAS FP64).  48 ranks, -nt 1, whole node.
