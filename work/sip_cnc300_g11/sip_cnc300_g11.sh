...
#PBS -N pcn300g11
#PBS -j o
#PBS -o sip_cnc300_g11.joblog

# H100 1-node production benchmark (plan v2.6 sec. 8.1/8.3): sip_cnc300_g11.
# 300 Si atoms from sidia.dat supercells, cluster solver, Gamma-only.
