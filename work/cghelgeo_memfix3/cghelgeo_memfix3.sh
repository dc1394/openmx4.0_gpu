...
#PBS -N cghelgeo_mf3
#PBS -j o
#PBS -o cghelgeo_memfix3.joblog

# HOST-MEMORY FIX VERIFICATION -- GPU PATH
# ---------------------------------
...
# per-rank OLPKPROF/phase lines on stderr: evidence for the Bessel-cache cap
