#!/bin/bash
# RTX 5080 local benchmark (rtx5080_procedure.md; plan v2.6 sec. 7.2/8.2/8.3): s5f_bcol384_g1.
# 384 Si atoms from sidia.dat supercells, band solver, Kgrid 2x2x2 (8 computed k).
# Config: GPU gpusolver + MPS on, gemmul8 on -> INT8 FP64 emulation (Layer 3).
# Fixed 3 SCF, MD.Type Opt / MD.maxIter 1; wall time = Max_Time column
