...
#PBS -N sb_c288p
#PBS -j o
#PBS -o sib_col288_p.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col288_p.
...
# System: 288 Si atoms (conv supercell 4x3x3 of sidia.dat, a=5.431 Ang),
# Si7.0-s2p2d1 -> 13 basis/atom: col dim n=3744, NC dim 2n=7488.
