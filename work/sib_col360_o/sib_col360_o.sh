...
#PBS -N sb_c360o
#PBS -j o
#PBS -o sib_col360_o.joblog

# Si diamond BAND-solver size search (research plan v2.6 sec. 7.3): sib_col360_o.
...
# Config: gpusolver + MPS, gemmul8 OFF -> plain cuBLAS FP64 (25-SCF confirmation, step 6).
