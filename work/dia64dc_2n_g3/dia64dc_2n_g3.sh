...
#PBS -N d64_2g3
#PBS -j o
#PBS -o dia64dc_2n_g3.joblog

# dia64_dc-lno node scaling, 2 node(s) x 48 ranks, GPU path (gpusolver + MPS, gemmul8 on).
...
# atom-owning ranks to min(numprocs, atomnum): of the 96 ranks here,
