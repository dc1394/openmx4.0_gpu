...
#PBS -N pbn216c4813
#PBS -j o
#PBS -o sip_bnc216_c4813.joblog

# H100 1-node production benchmark (plan v2.6 sec. 8.1/8.3): sip_bnc216_c4813.
...
mpirun ${NQSV_MPIOPTS:-} -np "${NPROC}" -npernode "${PPN}" --timeout 4440 \
