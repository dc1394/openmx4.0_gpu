...
#PBS -N s333_3g2
#PBS -j o
#PBS -o s333nc_3n_g2.joblog

# sidia333_nc campaign, GPU path (gemmul8 on) -- one of 36 requests
# ({1,2,3,4} nodes x {gpusolver+gemmul8-on, gpusolver+gemmul8-off, elpa2} x 3
# reps, all -npernode 48) so Total and Diagonalization come with a mean.
# Binary: round-3 (commit e227507).  216 Si, s2p2d1, non-collinear -> matrix
# dimension 5616, BAND solver (k-grid 2x2x2), 25 SCF iterations to 1e-13.
# Old-binary refs (PPN=48): GPU 1n 250 s, 2n 163 s, 4n 134 s; Utot -887.4228308564xx.
...
echo "=== Utot (old-binary refs: -887.4228308564xx) ==="
