...
#PBS -N a64g2
#PBS -j o
#PBS -o siacc64_g2.joblog

# H100 1-node production benchmark (plan v2.6 sec. 8.1/8.3): siacc64_g2.
# 360 Si atoms from sidia.dat supercells, cluster solver, Gamma-only.
...
MPS_X="-x CUDA_MPS_PIPE_DIRECTORY -x CUDA_MPS_LOG_DIRECTORY -x OPENMX_ACC_DUMP -x OPENMX_ACC_DUMP_SCF"
