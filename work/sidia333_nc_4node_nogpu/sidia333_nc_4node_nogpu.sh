...
#PBS -N s333_4node_nogpu
#PBS -j o
#PBS -o sidia333_nc_4node_nogpu.joblog
...
# collinear ../sidia333_* series.  Band solver, 2x2x2 k-grid, 25 SCF.  4 Pegasus node(s), 48 ranks
