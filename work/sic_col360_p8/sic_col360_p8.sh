...
#PBS -N cl_c360p8
#PBS -j o
#PBS -o sic_col360_p8.joblog

# Si diamond CLUSTER-solver size preflight (plan v2.6 step 10): sic_col360_p8.
...
# System: 360 Si atoms, Si7.0-s2p2d1: col dim n=4680 / NC dim 2n=9360.
# scf.EigenvalueSolver cluster, Gamma-only (Kgrid 1 1 1), GGA-PBE, 200 Ry,
# scf.maxIter 3, MD.Type Opt x1.  Config: gemmul8 on (3-SCF GO/NO-GO probe).
