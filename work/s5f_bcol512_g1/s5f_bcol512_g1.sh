#!/bin/bash
# RTX 5080 local benchmark (rtx5080_procedure.md; plan v2.6 sec. 7.2/8.2/8.3): s5f_bcol512_g1.
# 512 Si atoms from sidia.dat supercells, band solver, Kgrid 2x2x2 (8 computed k).
