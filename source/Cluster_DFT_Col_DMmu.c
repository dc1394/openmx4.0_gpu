                   ...
                   double *Work1)
{
  ...
  ****************************************************/
  ...
  if (SCF_iter==1){
    ...
    if (scf_eigen_lib_flag==1){
      ...
      OpenMX_GpuSolver_DenseDsyevx_1based(Cs,Ss,ko[0],n,n,"Cluster_DFT_Col_DMmu overlap GPUSOLVER");
    }
 ...
 diagonalize:
  ...
  if (scf_eigen_lib_flag==1){
    ...
    OpenMX_GpuSolver_DenseDsyevx_1based(Hs,Cs,ko[spin],n,MaxN,"Cluster_DFT_Col_DMmu Hamiltonian GPUSOLVER");
  }
